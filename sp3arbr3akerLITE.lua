...
local RAYCAST_MAX_DISTANCE = 10000
local UNDO_LIMIT = 25
...
local function ensureGuide()
	...
	do
		...
		local sep = track(Instance.new("Frame")); sep.Size=UDim2.new(1,0,0,1); sep.Position=UDim2.new(0,0,0,22+80+6); sep.BackgroundColor3=Color3.fromRGB(60,60,60); sep.BorderSizePixel=0; sep.Parent=guideFrame
